...
\begin{itemize}
	...
	$\theta = \frac{\pi}{2} - \phi$
	\item $\lambda$ : longitude, which is the azimuthal angle, angle of rotation around the polar axis
\end{itemize}
